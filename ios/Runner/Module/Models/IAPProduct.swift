...
struct IAPProduct {
    ...
    static let allProducts: [IAPProduct] = [
        ...
        IAPProduct(name: "首充月会员", productId: "com.nixi.mf.zuanshi88", description: "88元首次购买月会员", diamonds: nil, isMembership: true),
        IAPProduct(name: "月会员", productId: "com.nixi.m.zuanshi98", description: "98元购买月会员", diamonds: nil, isMembership: true),
        IAPProduct(name: "季会员", productId: "com.nixi.m.zuanshi268", description: "268元可购买季度会员", diamonds: nil, isMembership: true)
    ]
} 
